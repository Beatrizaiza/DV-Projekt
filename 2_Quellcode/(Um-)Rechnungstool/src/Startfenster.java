...
public class Startfenster {
	...
	public static void main(String[] args) {
		...
		hauptfenster.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // Befehl beim Schlei�en des Fensters//
		...
		JLabel labelMassband = new JLabel(new ImageIcon("Bild-Ma�band.png"));
